YUI.add('moodle-atto_styles2-button', function(Y, NAME) {
    ...
    /**
     * @module moodle-atto_styles2-button
     */

    /**
     * Atto text editor styles plugin.
     *
     * @namespace M.atto_styles2
     * @class button
     * @extends M.editor_atto.EditorPlugin
     */

    var component = 'atto_styles2';

    Y.namespace('M.atto_styles2').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        initializer: function() {
            ...
            Y.Array.each(styles, function(style) {
                ...
                if (style.type === 'nostyle') {
                    ...
                    icon = '<i class="fa fa-fw fa-text-width"></i>';
                    ...
                    inlinehint = '<br /><span class="inlinehint tag tag-info">' +
                        M.util.get_string('inlinehint', 'atto_styles2') + '</span>';
                }
        ...
        _setDropdownHeight: function() {
            ...
            Y.one('.editor_atto_menu .atto_styles2_button .dropdown-menu').setStyle('max-height', newHeight);
        }
    }, {
        ATTRS: {
            /**
