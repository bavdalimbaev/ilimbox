...
/**
 * Function to upgrade atto_styles2
 * @param int $oldversion the version we are upgrading from
 * @return bool result
 */
function xmldb_atto_styles2_upgrade($oldversion) {
    ...
    if ($oldversion < 2020100200) {
        ...
        $oldconfig = get_config('atto_styles2', 'config');
        ...
        if (strpos($oldconfig, '},') !== false &&
            ...
            set_config('config', $newconfig, 'atto_styles2');
        }
