...
class core_course_editcategory_form extends moodleform {
    ...
    public function definition() {
        ...
        $langOptions = array('ru' => 'Русский', 'ky' => 'Кыргызский');
        ...
        $mform->addElement('select', 'lang', get_string('categorylang'), $langOptions);
        $mform->addRule('lang', get_string('required'), 'required', null);
